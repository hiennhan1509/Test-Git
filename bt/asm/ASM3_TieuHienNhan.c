#include <stdio.h> /*use for printf, fprintf, scanf*/
...
void main()
{
    ...
    do
    {
        ...
        {   
            do
            {
                printf("Enter number of elements you want to input [1-100]: ");
                fflush(stdin);
                scanf("%d",&nInput);
                printf("\n");
            } while ((nInput<1)||(nInput>100));
            
            for (i = 0; i < nInput; i++) /*Input n Elements (n = 100) */
            {
                unsigned char j = 0;
